...
import com.czyl.project.system.domain.SysDictType;
import com.czyl.project.system.service.ISysDictTypeService;
...
public class SysDictTypeController extends BaseController {
	...
	@PostMapping
	@Lock4j(keys= {"#dict.dictName"},autoPrefix = true)
	...
	public AjaxResult edit(@Validated @RequestBody SysDictType dict) {
		try {
			...
			LockUtils.releaseLock(dict.getDictId());
		}
	}
