...
import com.czyl.project.system.mapper.SysPostMapper;
import com.czyl.project.system.mapper.SysUserPostMapper;
...
public class SysPostServiceImpl implements ISysPostService {
	 ...
	 */
	@Override
	public Integer checkPostNameUnique(SysPost post) {
	 ...
	 */
	@Override
	public Integer checkPostCodeUnique(SysPost post) {
		Long postId = StringUtils.isNull(post.getPostId()) ? -1L : post.getPostId();
