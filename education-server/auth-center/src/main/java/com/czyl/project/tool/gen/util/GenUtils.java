...
import com.czyl.framework.config.GenConfig;
...
public class GenUtils {
    ...
    public static void initTable(GenTable genTable, Long operId) {
        ...
        genTable.setGateway(GenConfig.getGateway());
    ...
    public static void initColumnField(GenTableColumn column, GenTable table) {
        ...
        if (arraysContains(GenConstants.COLUMNTYPE_STR, dataType)) {
            ...
            // 长整形
            else if ("bigint".equals(dataType) || ("number".equals(dataType) && str != null && str.length == 1 && Integer.parseInt(str[0]) > 10)) {
