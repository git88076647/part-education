...
import com.czyl.common.exception.job.TaskException.Code;
...
public class ScheduleUtils {
	...
	public static TriggerKey getTriggerKey(Long jobId, String jobGroup) {
		return TriggerKey.triggerKey(ScheduleConstants.JOB_CLASS_NAME + jobId, jobGroup);
	}
	...
	public static JobKey getJobKey(Long jobId, String jobGroup) {
		return JobKey.jobKey(ScheduleConstants.JOB_CLASS_NAME + jobId, jobGroup);
	}
	...
	public static void createScheduleJob(Scheduler scheduler, SysJob job) throws SchedulerException, TaskException {
		...
		// 放入参数，运行时的方法可以获取
		jobDetail.getJobDataMap().put(ScheduleConstants.JOB_PROPERTIES, job);
