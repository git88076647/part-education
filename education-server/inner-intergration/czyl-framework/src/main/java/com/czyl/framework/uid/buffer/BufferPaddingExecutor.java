...
package com.czyl.framework.uid.buffer;
...
import com.czyl.framework.uid.utils.NamingThreadFactory;
import com.czyl.framework.uid.utils.PaddedAtomicLong;
...
public class BufferPaddingExecutor {
	...
	public BufferPaddingExecutor(RingBuffer ringBuffer, BufferedUidProvider uidProvider, boolean usingSchedule) {
		...
		bufferPadExecutors = new ThreadPoolExecutor(cores * 2, cores * 2, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>(10240), new NamingThreadFactory(WORKER_NAME), new ThreadPoolExecutor.AbortPolicy());
