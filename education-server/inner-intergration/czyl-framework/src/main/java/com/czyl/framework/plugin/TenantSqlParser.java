...
public class TenantSqlParser extends AbstractJsqlParser {
    ...
    public void processInsert(Insert insert) {
        ...
        if (insert.getSelect() != null) {
            ...
            throw new CustomException("Failed to process multiple-table update, please exclude the tableName or statementId");
        }
    }
    ...
    protected Column getAliasColumn(Table table) {
        ...
        if (table.getAlias() != null) {
            column.append(table.getAlias().getName()).append(DOT);
        }
