/*
 ...
 Source Schema         : czyljob

 Target Server Type    : MySQL
 Target Server Version : 80018
 File Encoding         : 65001

 Date: 13/03/2020 18:27:24
*/
...
CREATE TABLE `sys_job`  (
  ...
  `exe_params` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '参数',
...
-- Records of sys_job
-- ----------------------------
INSERT INTO `sys_job` VALUES (2, '测试234', 'DEFAULT', 'sysDefaultJobTask', '0/15 * * * * ?', '0', 1, 1, 1, '2018-03-16 11:33:00', 1, '2020-03-12 22:31:55', '', 7, '222');
INSERT INTO `sys_job` VALUES (100, '测试123', 'DEFAULT', 'sysDefaultJobTask', '0/10 * * * * ?', '3', 1, 1, NULL, '2020-02-26 12:07:54', 1, '2020-03-12 22:16:03', '', 16, 'http://baidu.com');
...
) ENGINE = InnoDB AUTO_INCREMENT = 4135158778464624641 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '定时任务调度日志表' ROW_FORMAT = Dynamic;
